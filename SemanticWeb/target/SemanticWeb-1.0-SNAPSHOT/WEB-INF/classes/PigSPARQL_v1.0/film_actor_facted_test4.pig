...
-- BGP
f0 = FILTER indata BY p == '<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>' AND o == '<http://data.linkedmdb.org/resource/movie/flim>' ;
...
-- SM_Order
SM_Order = ORDER BGP1 BY o PARALLEL $reducerNum ;

-- SM_Project
SM_Project = FOREACH SM_Order GENERATE o ;
